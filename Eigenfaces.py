...
def get_images(path):
    ...
    cascadePath = "D:\Assign\\haarcascade_frontalface_default.xml"
...
if __name__ == "__main__":
    ...
    path = "E:\\ML Assignmentt\\Assignment 2\\New folder\\train data"
    images_train, labels_train = get_images(path)

    # Split the data into training and test
    path = "E:\\ML Assignmentt\\Assignment 2\\New folder\\test data"
